...
if [[ "$(tput colors)" == "256" ]]; then
    ...
    ZSH_HIGHLIGHT_STYLES[builtin]=fg=108
    ZSH_HIGHLIGHT_STYLES[function]=fg=108
    ZSH_HIGHLIGHT_STYLES[command]=fg=108
    ...
    ZSH_HIGHLIGHT_STYLES[path_pathseparator]=fg=217
    ZSH_HIGHLIGHT_STYLES[globbing]=fg=186
    ZSH_HIGHLIGHT_STYLES[history-expansion]=fg=186,underline
    ZSH_HIGHLIGHT_STYLES[single-hyphen-option]=fg=183
    ZSH_HIGHLIGHT_STYLES[double-hyphen-option]=fg=183
    ZSH_HIGHLIGHT_STYLES[back-quoted-argument]=fg=186
    ...
    ZSH_HIGHLIGHT_STYLES[back-double-quoted-argument]=fg=186
    ZSH_HIGHLIGHT_STYLES[assign]=fg=159
    ZSH_HIGHLIGHT_STYLES[comment]=fg=102
fi
